...
function validateTimeAndCursor(_a) {
    var _b = _a.showSeconds, showSeconds = _b === void 0 ? false : _b, _c = _a.value, value = _c === void 0 ? '' : _c, _d = _a.defaultValue, defaultValue = _d === void 0 ? '' : _d, _e = _a.colon, colon = _e === void 0 ? DEFAULT_COLON : _e, _f = _a.cursorPosition, cursorPosition = _f === void 0 ? 0 : _f, _g = _a.inputType, inputType = _g === void 0 ? DEFAULT_INPUT_TYPE : _g;
...
var TimeField = /** @class */ (function (_super) {
    ...
    TimeField.prototype.render = function () {
        ...
        return (react_1.default.createElement("input", __assign({ type: "text" }, props, { value: value, onChange: onChangeHandler, style: __assign({ width: showSeconds ? 54 : 35 }, style) })));
    };
